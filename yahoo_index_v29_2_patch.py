...
OUTDIR = Path("yahoo_index_v29_2_patch_outputs")
...
def simulate_portfolio_v25(candidates_packs, max_total_risk=0.1325, scenario_name="BOOST15"):
    ...
    return {
        ...
        "strategy_variant": "v29_2_RULE_MULT",
        "scenario": scenario_name,
        "trades": trades_df,
        "skipped": skipped_df,
        "equity": equity_df,
...
if __name__ == "__main__":
    ...
    try:
        res["trades"].to_csv(outdir / "v29_2_trades.csv", index=False)
        res["equity"].to_csv(outdir / "v29_2_equity.csv", index=False)
        res["skipped"].to_csv(outdir / "v29_2_skipped.csv", index=False)
        res["phase_transitions"].to_csv(outdir / "v29_2_phase_transitions.csv", index=False)
        res["excess_log"].to_csv(outdir / "v29_2_excess_log.csv", index=False)
        res["tax_log"].to_csv(outdir / "v29_2_tax_log.csv", index=False)
        all_cand.to_csv(outdir / "v29_2_all_candidates.csv", index=False)
        print(f"\n💾 CSV 저장 완료: {outdir}/")
    ...
    if len(tdf) == 0:
        ...
        summary_df.to_csv(outdir / "v29_2_summary.csv", index=False)
        ...
        monthly_summary.to_csv(outdir / "v29_2_monthly_summary.csv", index=False)
        ...
        asset_summary.to_csv(outdir / "v29_2_asset_summary.csv", index=False)
        ...
        if "tier_label" in tdf.columns:
            ...
            tier_summary.to_csv(outdir / "v29_2_tier_summary.csv", index=False)
        ...
        if "v25idx_subtier" in tdf.columns:
            ...
            subtier_summary.to_csv(outdir / "v29_2_v25idx_subtier_summary.csv", index=False)
            ...
            rule_summary.to_csv(outdir / "v29_2_v25idx_rule_summary.csv", index=False)

        # 차트
        try:
            plot_equity_v25(res, save_path=str(outdir / "v29_2_equity_chart.png"))
        except Exception as e:
