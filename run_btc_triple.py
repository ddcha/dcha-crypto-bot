#!/usr/bin/env python3
# setups_btc_triple.json(114규칙) 3중게이트(atoms × btc_zone × side) 진짜게이트 + KRW 자본시뮬.
...
CACHE = "prepared_cache.pkl"; RULES_JSON = "setups_btc_triple.json"; OUTDIR = "btc_triple_result"
INIT_KRW = 5_000_000; MONTHLY_KRW = 2_500_000; NDEP = 5
KRW_USDT = 1540.0; RISK_PCT = 0.01; FEE = 0.00055; MAXNOT = 3.0
REF = {"n": 826, "PF": 1.80, "OOS": 1.42}
