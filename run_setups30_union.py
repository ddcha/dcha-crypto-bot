#!/usr/bin/env python3
# =========================================================================
# run_setups30_union.py — setups_30.json "최대원자 귀속 union 게이트" 단일 백테스트 + 자본시뮬
#
...
#   실행:  set STAGE4D_DLCACHE=data_cache & python run_setups30_union.py
# =========================================================================
import os, json, time
...
os.environ["COMBO_UNION_JSON"] = "setups_30.json"   # 30셋업 atomset 자동 로드(config L166)
...
SETUPS_JSON = "setups_30.json"
OUTDIR = "setups30_union_result"
...
def main():
    ...
    # 지표 + 자본시뮬
    row = summarize("setups30_union", trades)
