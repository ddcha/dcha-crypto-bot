...
START_YEAR = 2022
START_MONTH = 1
LOOKBACK_YEARS = 5   # ★ LB5: 2021-06부터 (LUNA+FTX+BTC ATH 사이클 포함)
...
_DATA_CACHE_DIR = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), "data_cache_lb5")  # ★ LB5: 별도 캐시
