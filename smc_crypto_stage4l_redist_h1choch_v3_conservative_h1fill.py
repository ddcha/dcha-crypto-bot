...
H1_BARS_PER_H4 = 4
FAST_2R_BARS_MAX_H1 = FAST_2R_BARS_MAX * H1_BARS_PER_H4   # 3 → 12
ABOVE_2R_BARS_MIN_H1 = ABOVE_2R_BARS_MIN * H1_BARS_PER_H4  # 3 → 12
...
USE_H1_BAR_BY_BAR_SIMULATOR = True  # ★ H1 fill 활성 스위치 (기본 OFF, 호환 유지)
print(f"[H1-FILL] USE_H1_BAR_BY_BAR_SIMULATOR = {USE_H1_BAR_BY_BAR_SIMULATOR}  (H1_FILL_TIE_BREAK={H1_FILL_TIE_BREAK})")
...
def _simulate_trade_with_plan_core(df_local, entry_idx, side, entry, sl, qty, fee_rate, grade, plan,
    ...
    # ★ [PATCHED H1-fill] H1 모드면 "봉 수" 의존 runner 조건을 ×4 값으로 사용.
    # (max_hold_bars 는 호출부에서 이미 ×4 되어 plan 으로 들어옴)
    _fast_2r_max = FAST_2R_BARS_MAX_H1 if h1_mode else FAST_2R_BARS_MAX
    _above_2r_min = ABOVE_2R_BARS_MIN_H1 if h1_mode else ABOVE_2R_BARS_MIN
