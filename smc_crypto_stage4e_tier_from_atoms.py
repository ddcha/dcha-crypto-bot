# =========================================================
# smc_crypto_9coins  STAGE 4E: TIER FROM ATOMS
#
# [실험 목적]
...
def classify_tier_stage4e(atoms_dict):
    ...
    # ── Tier B: 최소 하나 이상 alpha ──
    # weak signal but still has something
    if vol or swp or s13 or p4:
        return "B"
...
print()
print("=" * 75)
print("[Stage 4E] candidates 생성 — Tier 완전 재설계 (12 atomic 기반)")
print("=" * 75)
