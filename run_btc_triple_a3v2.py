#!/usr/bin/env python3
# setups_btc_triple_a3v2.json(114규칙) 3중게이트(atoms × btc_zone × side) 진짜게이트 + KRW 자본시뮬.
...
CACHE = "prepared_cache.pkl"; RULES_JSON = "setups_btc_triple_a3v2.json"; OUTDIR = "btc_triple_a3v2_result"
INIT_KRW = 5_000_000; MONTHLY_KRW = 2_500_000; NDEP = 5
KRW_USDT = 1540.0; RISK_PCT = 0.01; FEE = 0.00055; MAXNOT = 3.0
REF = {"n": 662, "PF": 1.61, "OOS": 1.61}
