...
def _default_settings() -> Dict[str, Any]:
    return {
        ...
        "portfolio": {"max_open_positions": 9, "risk_multiplier": 1.0},   # ⭐ 7 → 9 (BNB+ADA 추가)
        ...
        "assets": {
            ...
            # ⭐ Stage 4K 9코인 확장 (백테 baseline 과 동일 risk_pct)
            # ⚠️ qty_step / min_order_qty / qty_decimals: Bybit instruments-info 검증 후 조정 필요
            "BNBUSDT":  {"enabled": True, "risk_pct": 0.012, "qty_step": 0.01,  "min_order_qty": 0.01,  "qty_decimals": 2, "allow_long": True, "allow_short": True},
            "ADAUSDT":  {"enabled": True, "risk_pct": 0.008, "qty_step": 1,     "min_order_qty": 1,     "qty_decimals": 0, "allow_long": True, "allow_short": True},
        },
    }
