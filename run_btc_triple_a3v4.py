#!/usr/bin/env python3
# setups_btc_triple_a3v4.json(114규칙) 3중게이트(atoms × btc_zone × side) 진짜게이트 + KRW 자본시뮬.
...
CACHE = "prepared_cache.pkl"; RULES_JSON = "setups_btc_triple_a3v4.json"; OUTDIR = "btc_triple_a3v4_result"
